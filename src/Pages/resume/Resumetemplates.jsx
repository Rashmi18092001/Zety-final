import resume1 from'../../images/template/cascade.png'
import resume2 from'../../images/template/concept.png'
import resume3 from'../../images/template/crisp.png'
import resume4 from'../../images/template/cubic.png'
import resume5 from'../../images/template/diamond.png'
import resume6 from'../../images/template/enfold.png'
import resume7 from'../../images/template/iconic.png'
import resume8 from'../../images/template/influx.png'
import resume9 from'../../images/template/initials.png'
import resume10 from'../../images/template/minimo.png'
import resume11 from'../../images/template/modern.png'
import resume12 from'../../images/template/muse.png'
import resume13 from'../../images/template/nanica.png'
import resume14 from'../../images/template/newcast.png'
import resume15 from'../../images/template/primo.png'
import resume16 from'../../images/template/simple.png'
import resume17 from'../../images/template/valera.png'
import resume18 from'../../images/template/vibes.png'
import step1 from '../../images/template/Step 1.png'
import image1 from'../../images/template/cascade-mid-level.png'
import image2 from'../../images/template/concept-entry-level.png'
import image3 from'../../images/template/simple-senior.png'
import image4 from'../../images/template/crisp-no-experience.png'
import image5 from'../../images/template/cubic-mid-level-gray.png'
import image6 from'../../images/template/minimo-senior-sand.png'
import image7 from'../../images/template/word-resume-template.png'
import image8 from'../../images/template/google-docs-resume-template.png'
import image9 from'../../images/template/open-office-resume-template.png'
import card1 from '../../images/template/templates@3x.webp'
import card2 from '../../images/template/designed_by_experts@3x.webp'
import card3 from '../../images/template/upload_resume@3x.webp'
import card4 from '../../images/template/ttc@3x.webp'
import card5 from '../../images/template/shine@3x.webp'
import card6 from '../../images/template/generate-unlimited@3x.webp'
import './Temaplates.css'
function ResumeTemplates(){
    return(<>

<div className="Template-Pages">
            <h1 style={{ fontSize: "50px", paddingTop:"40px"}}>Resume Templates to Download and Print</h1>
            ...
            <button className="Template-Page-Button">Create your resume now</button>
        </div>
        <div className='Template-Hover-Section'>
            <div className='Template-Card-Section'>
                <img className='Template-Section-Hover' src={resume1} alt={step1} />
                <h1>Cascade</h1>
                <p>This professional resume template is the most popular one. It shows your info clearly and neatly.</p>
            </div>
            <div className='Template-Card-Section'>
                <img className='Template-Section-Hover' src={resume2} alt={step1} />
                <h1>Concept</h1>
                <p>A modern resume template that offers a sleek design with an eye-catching timeline.</p>
            </div>
            <div className='Template-Card-Section'>
                <img className='Template-Section-Hover' src={resume3} alt={step1} />
                <h1>Crisp</h1>
        ...
        <div className='Template-Section'>
            <div className='Template-Copy-Free-Content col-lg-6'>
            ...
            <div className='Template-Scroll  col-lg-6'>
        ...
        <section className="Template-Resume-Cards">
            <div className="Template-Cards col-lg-4">
                <img  src={image1} alt={step1}></img>
        ...
        <button className='Template-Page-Button'>Create your own resume</button>
        </div>
        <div>
        <h1 style={{ textAlign: "center" }}>Free Resume templates by File Format.</h1>
        <section className="Template-Resume-Cards">
            <div className="Template-Cards col-lg-4">
                <img src={image7} alt={step1}></img>
      ...
      <section>
        <div className='ColorSection'>
            ...
            <button className='Template-Page-Button'>Try Our resume builder</button>
        </div>
      </section>
      <section className="Template-Head-Article">
      <img  className="Temaplate-Head-Image col-lg-6"src={card1} alt={step1}></img>
        <div className="Template-Head-Card col-lg-6">
      ...
      <section className="Template-Head-Article">
        ...
        <img  className="Temaplate-Head-Image col-lg-6"src={card2} alt={step1}></img>
      </section><hr style={{margin:"70px"}}></hr>
      <section className="Template-Head-Article">
      <img  className="Temaplate-Head-Image col-lg-6"src={card3} alt={step1}></img>
        <div className="Template-Head-Card col-lg-6">
      ...
      <section className="Template-Head-Article">
        ...
        <img  className="Temaplate-Head-Image col-lg-6"src={card4} alt={step1}></img>
      </section><hr style={{margin:"70px"}}></hr>
      <section className="Template-Head-Article">
      <img  className="Temaplate-Head-Image col-lg-6"src={card5} alt={step1}></img>
        <div className="Template-Head-Card col-lg-6">
      ...
      <section className="Template-Head-Article">
        ...
        <img  className="Temaplate-Head-Image col-lg-6"src={card6} alt={step1}></img>
      </section>
...
<button className="Template-Page-Button">Create your Fast Resume Builder</button>
    </div>
    <hr style={{margin:"70px"}}></hr>
...
<button className="Template-Page-Button">Make your resume online
</button>
